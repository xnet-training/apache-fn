...
public class Visit {
    ...
    /**
     * Vehiculo asignado a la visita
     */
    private Vehicle vehicle;

    /**
     * Visita previa de la secuencia de visitas de la ruta (null si es la primeta)
     */
    private Visit previousVisit;
    /**
     * Visita siguiente de la secuencia de visitas de la ruta (null si es última)
     */
    private Visit nextVisit;

    /**
     * Fecha y hora de arrivo al punto de visita
     */
